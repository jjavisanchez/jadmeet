	...
	if (this.enableTooltips && this.showTooltips)
	{
		if (this.currentElt != elt)
		{
			...
			var show = mxUtils.bind(this, function()
			{
				...
				this.tooltip.style.top = (top + 150) + 'px';
				this.tooltip.style.visibility = 'hidden';
				this.tooltipImage.style.left = (left) + 'px';
				this.tooltipImage.style.top = (top + height / 2 + 113) + 'px';
...
Sidebar.prototype.addUmlPalette = function(expand)
{
	this.addPalette('uml', 'UML', expand || false, mxUtils.bind(this, function(content)
	{
    	...
    	content.appendChild(this.createVertexTemplateFromCells([classCell1, classCell2], 100, 290, 'Class/Object', true));
