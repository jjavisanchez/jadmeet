...
function prepareCanvas()
{
	...
	var canvasDiv = document.getElementById('espacio_diagrama');
	...
	crayonImage.src = "{{ asset('bundles/sesionjad/images/canvas/crayon-outline.png') }}"  ;
	//context.drawImage(crayonImage, 0, 0, 100, 100);

	markerImage.onload = function() { resourceLoaded();
	}
	markerImage.src = "{{ asset('bundles/sesionjad/images/canvas/marker-outline.png') }}";

	eraserImage.onload = function() { resourceLoaded();
	}
	eraserImage.src = "{{ asset('bundles/sesionjad/images/canvas/eraser-outline.png') }}";

	crayonBackgroundImage.onload = function() { resourceLoaded();
	}
	crayonBackgroundImage.src = "{{ asset('bundles/sesionjad/images/canvas/crayon-background.png') }}";

	markerBackgroundImage.onload = function() { resourceLoaded();
	}
	markerBackgroundImage.src = "{{ asset('bundles/sesionjad/images/canvas/marker-background.png') }}";

	eraserBackgroundImage.onload = function() { resourceLoaded();
	}
	eraserBackgroundImage.src = "{{ asset('bundles/sesionjad/images/canvas/eraser-background.png') }}";

	crayonTextureImage.onload = function() { resourceLoaded();
	}
	crayonTextureImage.src = "{{ asset('bundles/sesionjad/images/canvas/crayon-texture.png') }}";

	outlineImage.onload = function() { resourceLoaded();
	}
	outlineImage.src = "{{ asset('bundles/sesionjad/images/canvas/watermelon-duck-outline.png') }}";
